...
(function ($, window, document, Date) {
    ...
    var _markup =
        '<div class="ui-widget-header month-picker-header ui-corner-all ui-monthpicker">' +
    ...
    $.widget("KidSysco.MonthPicker", {
        ...
        _create: function () {
            ...
            var _menu = this._monthPickerMenu = $('<div id="MonthPicker_' + _el[0].id + '" class="month-picker ui-widget ui-widget-content ui-corner-all ui-monthpicker"></div>').hide();
